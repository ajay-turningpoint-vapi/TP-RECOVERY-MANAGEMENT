                ...
                children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(isDense: true, border: InputBorder.none, hintText: 'Search by task title, customer or owner', hintStyle: TextStyle(fontSize: 11.5, color: kMuted)),
                    ),
                  ),
                ],
              ),
